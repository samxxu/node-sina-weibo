...
//SinaWeibo.prototype.setAccessToken = function (accessToken) {
//    this._accessToken = accessToken;
//}
...
SinaWeibo.prototype.getAccessToken = function (params, callback) {
    ...
    this.oAuth.getOAuthAccessToken(code, params, function (err, accessToken, refreshToken, result) {
        ...
        callback(err, result, accessToken, refreshToken);
    });
};

SinaWeibo.prototype.getOauth2Token = function (params, callback) {
    var code = params.code;
